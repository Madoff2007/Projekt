...
import { TechnologyvikdataComponent } from './technologyvikdata.component';

describe('TechnologyvikdataComponent', () => {
  beforeEach(async () => {
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(TechnologyvikdataComponent);
