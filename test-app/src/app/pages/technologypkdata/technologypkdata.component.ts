...
@Component({
  selector: 'app-technologypkdata',
  templateUrl: './technologypkdata.component.html',
  styleUrls: ['./technologypkdata.component.scss']
})
export class TechnologypkdataComponent implements OnInit {
