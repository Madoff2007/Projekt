...
import { TechnologyykdataComponent } from './technologyykdata.component';

describe('TechnologyykdataComponent', () => {
  beforeEach(async () => {
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(TechnologyykdataComponent);
