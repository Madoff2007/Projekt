...
@Component({
  selector: 'app-technologyykdata',
  templateUrl: './technologyykdata.component.html',
  styleUrls: ['./technologyykdata.component.scss']
})
export class TechnologyykdataComponent implements OnInit {
  title = 'test-app';
